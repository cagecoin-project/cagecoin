...
{
    int64 nSubsidy = 100000 * COIN; // payout per block

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // cagecoin: 1 days
static const int64 nTargetSpacing = 600; // cagecoin: 6 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x98b3d9dfd845700fcdeadd732f6ec5f29ebe99f43cc9da1c2fd4694ba1f1a755");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Nicolase Cage is love Nicolase Cage is life.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388481705; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1345972;

        if (fTestNet)
        {
            block.nTime    = 1388481705;
            block.nNonce   = 3612072;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe4bde5a0560211fed1bfc676c13efc45939ed7c003ce844b82350503395b9c60"));
